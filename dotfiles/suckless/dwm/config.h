...
static const char *dmenucmd[] = { "dmenu_run", "-i", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray1, "-sf", "#ffffff", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_Escape, spawn,          SHCMD("xlock") },
