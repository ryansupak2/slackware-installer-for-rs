...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { "#ffffff", col_gray1, col_gray1 },
};
...
static const char *surfcmd[]  = { "/usr/local/bin/browser", NULL };
